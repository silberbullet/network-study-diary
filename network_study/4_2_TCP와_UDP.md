...
![image (1)](https://github.com/user-attachments/assets/8ef3f430-858a-4f43-a8b0-cf0892171fae)
...
![image (2)](https://github.com/user-attachments/assets/a51941d0-8e3e-4fa2-820e-ba64fdcfee6b)
...
- **TCP 연결 전 우리는 소켓을 만들어야 합니다**

**소켓(Socket)** 은 컴퓨터 네트워크에서 서로 다른 프로세스 간에 데이터를 주고받기 위한 **통신의 끝점**을 의미합니다. 소켓은 서버와 클라이언트 간의 통신을 가능하게 하며, 양방향 데이터 전송을 위한 인터페이스를 제공합니다.

![image (3)](https://github.com/user-attachments/assets/150b127e-52bc-4cb3-9831-97058cb8e472)
